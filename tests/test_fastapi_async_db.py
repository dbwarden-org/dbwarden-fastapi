...
class TestMakeSessionDep:
    ...
    def test_returns_callable(self):
        from dbwarden_fastapi.engines import _make_session_dep
    ...
    def test_dependency_is_async_generator_function(self, monkeypatch):
        ...
        monkeypatch.setattr("dbwarden_fastapi.engines.get_database", mock_get_database)
        monkeypatch.setattr("dbwarden_fastapi.engines.runtime_flags", lambda dev, strict_translation: type("ctx", (), {
...
class TestMakeClickHouseDep:
    ...
    def test_returns_callable(self):
        from dbwarden_fastapi.engines import _make_clickhouse_dep
...
class TestDisposeEngines:
    ...
    def test_dispose_engines_skips_non_bind_factories(self):
        ...
        from dbwarden_fastapi.engines import _dispose_one
