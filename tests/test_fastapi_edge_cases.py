...
from dbwarden_fastapi.runtime import HealthResult
...
class TestHealthRouterEdgeCases:
    ...
    def test_health_returns_503_when_error(self, monkeypatch):
        ...
        monkeypatch.setattr("dbwarden_fastapi.health.check_startup", fake_check_startup)
        app.include_router(
            __import__("dbwarden_fastapi", fromlist=["DBWardenHealthRouter"]).DBWardenHealthRouter(),
            prefix="/health"
        )
    ...
    def test_single_database_not_found(self, monkeypatch):
        ...
        monkeypatch.setattr("dbwarden_fastapi.health.get_multi_db_config", lambda: FakeCfg())
...
class TestMigrationContextEdgeCases:
    ...
    async def test_migration_context_checks_all_databases(self, monkeypatch):
        ...
        monkeypatch.setattr("dbwarden_fastapi.runtime.check_startup", lambda **kwargs: [mock_result])
        monkeypatch.setattr("dbwarden_fastapi.context.check_startup", lambda **kwargs: [mock_result])
...
class TestGetSessionEdgeCases:
    ...
    def test_session_caching(self, monkeypatch):
        ...
        from dbwarden_fastapi import session as session_module
...
class TestDBWardenLifespan:
    ...
    def test_lifespan_mode_check_calls_dispose(self):
        ...
        from dbwarden_fastapi import engines
