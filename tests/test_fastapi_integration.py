...
class TestStartupHelpers:
    ...
    def test_migrate_on_startup_only_dev_skips_outside_dev(self, monkeypatch):
        ...
        monkeypatch.setattr("dbwarden_fastapi.context.migrate_cmd", fake_migrate_cmd)
    ...
    def test_readiness_endpoint(self, monkeypatch):
        ...
        class FakeResult:
            ...
            def to_database_health(self):
                from dbwarden_fastapi.types import DatabaseHealth
        ...
        monkeypatch.setattr("dbwarden_fastapi.health.check_startup", fake_check)
        monkeypatch.setattr("dbwarden_fastapi.health.get_multi_db_config", fake_cfg)
